...
!(function (t, e) {
	...
	return (function (t) {
						...
						if ('[]' === a)
							return (
								...
								Array.isArray(t)
									...
									: ((t._values = t._values || []), t._values.push(hash_assign(null, e, r))),
								t
							)
						if (o) {
							var n = o[1],
					...
					if ((e.disabled || !u.disabled) && u.name && n.test(u.nodeName) && !o.test(u.type)) {
						...
						if ((('checkbox' !== u.type && 'radio' !== u.type) || u.checked || (f = void 0), e.empty)) {
							if (
								...
								'radio' === u.type && (c[u.name] || u.checked ? u.checked && (c[u.name] = !0) : (c[u.name] = !1)),
						...
						if ('select-multiple' !== u.type) r = i(r, d, f)
							...
							for (var h = u.options, y = !1, p = 0; p < h.length; ++p) {
								...
								m.selected &&
									v &&
									((y = !0), (r = e.hash && '[]' !== d.slice(d.length - 2) ? i(r, d + '[]', m.value) : i(r, d, m.value)))
							}
							!y && e.empty && (r = i(r, d, ''))
						}
					}
		...
		function (t, e, r) {
			...
			;(fetch.polyfill = !0),
				o.fetch || ((o.fetch = fetch), (o.Headers = Headers), (o.Request = Request), (o.Response = Response))
			var d = r(0),
				f = r.n(d)
									...
									document.querySelectorAll(this.itemQuantityMinus).forEach(function (t) {
										t.addEventListener('click', function () {
											var r = t.parentNode.parentNode.parentNode.parentNode.getAttribute('data-line'),
												a = Number(t.parentNode.querySelector(e.itemQuantity).value) - 1
											e.changeItemQuantity(r, a),
												0 === Number(t.parentNode.querySelector(e.itemQuantity).value - 1) &&
													GoCart.removeItemAnimation(t.parentNode.parentNode.parentNode.parentNode)
										})
									})
							},
						},
